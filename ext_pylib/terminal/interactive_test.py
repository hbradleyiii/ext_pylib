...
def print_assorted_combinations():
    ...
    print('\n\t----------------------------------------------------------')
    print('\tPrinting Assorted Combinations of Selected Color Functions')
    print('\t----------------------------------------------------------')
    ...
    print('Row 1:             | Row 2:              | ')
    print(colors.black_on_red('black on red'))
    print(colors.red(colors.reverse('red on white rev'), colors.on_white))
    print(colors.cyan('cyan'))
    print(colors.green('green bold', colors.bold))
    print(colors.yellow(colors.underline('yellow underlined')))
    print(colors.magenta('magenta'))
    print(colors.blue(colors.blink('blue/white blink'), colors.on_white))
    print(colors.on_red('white on red', colors.white))

    ansi.cursor_up(8)
    ansi.cursor_right(20)

    print(colors.black_on_white('black on white'))
    ansi.cursor_right(20)
    print(colors.red_on_black('red on black'))
    ansi.cursor_right(20)
    print(colors.green_on_red('green on red'))
    ansi.cursor_right(20)
    print(colors.yellow_on_green('yellow on green'))
    ansi.cursor_right(20)
    print(colors.blue_on_yellow('blue on yellow'))
    ansi.cursor_right(20)
    print(colors.magenta_on_blue('magenta on blue'))
    ansi.cursor_right(20)
    print(colors.cyan_on_magenta('cyan on magenta'))
    ansi.cursor_right(20)
    print(colors.white_on_cyan('white on cyan'))
